        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Discover the wonders of learning with our exciting courses in English, Math, and Science for kids! Dive into the magic of language, explore the mysteries of numbers, and unlock the secrets of the natural world through fun, interactive lessons designed to ignite young imaginations and build a foundation for lifelong learning.</p>
                </div>
