...
<body>
    ...
    var englishQuestions = [
        { question: 'What is the opposite of happy?', options: ['A) Sad', 'B) Joyful', 'C) Excited'], answer: 'A' },
        { question: 'What is a synonym for "big"?', options: ['A) Small', 'B) Large', 'C) Tiny'], answer: 'B' },
        { question: 'What is the plural of "cat"?', options: ['A) Cats', 'B) Cat', 'C) Cattes'], answer: 'A' },
        { question: 'What is the past tense of "run"?', options: ['A) Runs', 'B) Ran', 'C) Running'], answer: 'B' },
        { question: 'What is the first letter of the alphabet?', options: ['A) A', 'B) B', 'C) C'], answer: 'A' }
    ];

    var currentQuestionIndex = 0;

    function checkAnswer(answer) {
        var correctAnswer = englishQuestions[currentQuestionIndex].answer;
    ...
    function nextQuestion() {
        var randomIndex = Math.floor(Math.random() * (englishQuestions.length - currentQuestionIndex)) + currentQuestionIndex;
        var currentQuestion = englishQuestions[randomIndex];
        englishQuestions[randomIndex] = englishQuestions[currentQuestionIndex];
        englishQuestions[currentQuestionIndex] = currentQuestion;
...
// Function to store the result into a file
function storeResult(score) {
        const result = `Final Score: ${score}\n`;
