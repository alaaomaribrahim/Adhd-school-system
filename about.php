        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p6>Teachers like mayar sobhy , Ahmed Ali ,kareen vector, have made significant impacts in education with their dedication and innovative methods. Their work continues to inspire students and educators worldwide.</p6>
                </div>
                <div class="row g-4">
