...
<?php endif; ?>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>"Stay connected with us! Whether you have questions, feedback, or just want to say hello, we're here to listen. Feel free to reach out through email, phone, or visit our office. We look forward to hearing from you!"</p>
                </div>
    ...
    <label for="name">Your Name</label>
                                        ...
                                        <div class="col-sm-6">
                                         ...
                                         <input type="email" id="email" name="email" class="form-control border-0" placeholder="Your Email" required maxlength="100">
    <label for="email">Your Email</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                ...
                                                <!-- <input type="number" min="0" max="10" placeholder="enter your child age" required maxlength="10" name="number" class="box"> -->
